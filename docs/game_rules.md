# AID Rummikub — Detailed reference (game rules, encodings, R1–R9 notes)

> This is the detailed reference: full game definition, observation/action
> encodings, the ILP solver, the PPO-era pipeline, and round-by-round notes
> through R9. For the current project overview and headline results, see
> [`README.md`](../README.md).
